        ...
        private static List<EgoGift> CreateTier2Gifts()
        {
            var gifts = new List<EgoGift>
            {
                                ...
                                new EgoGift
                {
                    ...
                    Tier = 2,
                    Status = "Утопание",
                    ImagePath = "Resources/Images/EGO/Tier2/Алый указ.png",
                    Effect = @"Всякий раз, когда союзник накладывает sinking, Счётчик sinking, или 'Уникальное sinking' на врагов эффектами Скилла, он получает 1 offenseLevelUp на следующий Ход. (Макс. 3)

                Союзники с Скиллами греха Уныния или Гнева, при нанесении sinking или Счётчика sinking, получают 2 offenseLevelUp на следующий Ход вместо предыдущего эффекта. (Макс. 4)",
                    Description = "Алый указ, усиливающий атаку при наложении утопания, особенно эффективный для Уныния и Гнева.",
                    Cost = 188,
                    SellPrice = 94,
                    Acquisition = "Магазин и Событие: Апостол многоножки",
                    Keywords = "sinking, утопание, offenseLevelUp, уныние, гнев, усиление атаки, указ",
                    Sources = new List<Sources>
                    {
                        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.14 },
                        new Sources { Location = "Событие: Апостол многоножки", Type = "Event", DropRate = 0.07 }
                    }
                },
                                new EgoGift
                {
                    Name = "Плата точечного удара",
                    Tier = 2,
                    Status = "Огонь",
                    ImagePath = "Resources/Images/EGO/Tier2/Плата точечного удара.png",
                    Effect = @"При попадания Скиллом принадлежности Зависти или Скиллом, накладывающим burn или 'Уникальный burn', накладывает дополнительный burn, равный половине общего количества Монеток Скилла. (округление в большую сторону)",
                    Description = "Плата точечного удара, усиливающая эффекты горения для навыков Зависти и огненных атак.",
                    Cost = 204,
                    SellPrice = 102,
                    Acquisition = "Магазин и Событие: kqe-1j-23",
                    Keywords = "burn, огонь, зависть, монетки, горение, усиление",
                    Sources = new List<Sources>
                    {
                        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.13 },
                        new Sources { Location = "Событие: kqe-1j-23", Type = "Event", DropRate = 0.09 }
                    }
                },
                                new EgoGift
                {
                    Name = "Учебные флеш-карточки",
                    Tier = 2,
                    Status = "Дробящий",
                    ImagePath = "Resources/Images/EGO/Tier2/Учебные флеш-карточки.png",
                    Effect = @"После выигрыша столкновения Дробящим Базовым Атакующим Навыком, накладывает 2 defenseLevelDown в следующем ходу против цели. (один раз за ход для каждой Идентичности; эффект не может накладываться на одного и того же врага)

                - Для Идентичностей Ассоциации Дьечи: вышеуказанный эффект также применяется к Рубящим и Колющим Базовым Атакующим Навыкам; накладывает 1 дополнительный defenseLevelDown

                Если Идентичность Ассоциации Дьечи сбрасывает свой собственный Навык, используя discard Навык, получает (ранг Сброшенного Навыка) offenseLevelUp в начале следующего хода. (если сброшено несколько, получает наивысшее значение; макс 3)",
                    Description = "Учебные флеш-карточки, ослабляющие защиту врагов после выигранных столкновений и усиливающие идентичности Ассоциации Дьечи при сбросе навыков.",
                    Cost = 201,
                    SellPrice = 101,
                    Acquisition = "Магазин",
                    Keywords = "дробящий, defenseLevelDown, ассоциация дьечи, discard, offenseLevelUp, ослабление защиты",
                    Sources = new List<Sources>
                    {
                        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.15 }
                    }
                                ...
                                new EgoGift
{
    Name = "Воспоминание того дня",
    Tier = 2,
    Status = "Дыхание",
    ImagePath = "Resources/Images/EGO/Tier2/Воспоминание того дня.png",
    Effect = @"3 Скилл Идентичностей, который дает poise или Счётчик poise от Скиллов (исключая ЭГО Скиллы): +2 к Итоговому Значению Cкилла",
    Description = "Воспоминание того дня, усиливающее третий навык идентичностей, дающий poise или счётчик poise.",
    Cost = 213,
    SellPrice = 107,
    Acquisition = "Магазин",
    Keywords = "дыхание, poise, итоговое значение, усиление скиллов, память",
    Sources = new List<Sources>
    {
        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.12 }
    }
                                ...
                                new EgoGift
{
    ...
    Tier = 2,
    Status = "Универсальный",
    ImagePath = "Resources/Images/EGO/Tier2/Золотая урна.png",
    Effect = "Получайте +20% Коста после победы в Бою. (Не зависит от стартовых усилений или других ЭГО Даров)",
    Description = "Золотая урна, увеличивающая получаемую награду после победы в бою.",
    Cost = 180,
    SellPrice = 90,
    Acquisition = "Магазин и Событие: Золотая хватка",
    Keywords = "универсальный, кост, награда, бой, победа, усиление награды",
    Sources = new List<Sources>
    {
        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.14 },
        new Sources { Location = "Событие: Золотая хватка", Type = "Event", DropRate = 0.06 }
    }
},
                                new EgoGift
{
    Name = "Скопление алых мотыльков",
    Tier = 2,
    Status = "Универсальный",
    ImagePath = "Resources/Images/EGO/Tier2/Скопление алых мотыльков.png",
    Effect = @"[Начало Хода] При первом нанесении урона Скиллом, наносит половину от него случайному противнику в виде фиксированного урона.

Если же Скилл принадлежности Похоти, урон наносится 2-ум случайным противникам.",
    Description = "Скопление алых мотыльков, наносящее дополнительный фиксированный урон при первой атаке за ход, особенно эффективное для навыков Похоти.",
    Cost = 220,
    SellPrice = 110,
    Acquisition = "Магазин и Событие: Путник заката",
    Keywords = "универсальный, фиксированный урон, похоть, начало хода, мотыльки",
    Sources = new List<Sources>
    {
        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.13 },
        new Sources { Location = "Событие: Путник заката", Type = "Event", DropRate = 0.08 }
    }
},
new EgoGift
{
    ...
    Tier = 2,
    Status = "Утопание",
    ImagePath = "Resources/Images/EGO/Tier2/Костные останки.png",
    Effect = @"Наносите на +12.5% больше и получайте на -12.5% меньше урона против врагов, имеющих sinking в Начале Фазы Боя.

Союзники со Скиллами принадлежности Уныния наносят на +20% больше и получают на -20% меньше урона вместо предыдущего эффекта.",
    Description = "Костные останки, усиливающие атаку и защиту против врагов с утопанием, особенно эффективные для идентичностей с навыками Уныния.",
    Cost = 205,
    SellPrice = 103,
    Acquisition = "Магазин и Событие: Костяная гробница",
    Keywords = "утопание, sinking, уныние, усиление урона, снижение урона, защита, кости",
    Sources = new List<Sources>
    {
        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.15 },
        new Sources { Location = "Событие: Костяная гробница", Type = "Event", DropRate = 0.07 }
    }
},
new EgoGift
{
    ...
    Tier = 2,
    Status = "Кровотечение",
    ImagePath = "Resources/Images/EGO/Tier2/Белый хлопок.png",
    Effect = @"[Начало Хода] На Оглушённых врагов накладывается bleed по формуле (8 + уровень Оглушёния х 4) и offenseLevelDown по формуле ((8 + уровень Оглушёния х 4)/2), после наложения этих эффектов Оглушение снимается. (Активируется один раз за Бой для каждого врага. Не активируется против определённых врагов, которые не восстанавливаются от Оглушёния)",
    Description = "Белый хлопок, наносящий сильное кровотечение и ослабляющий атаку оглушённым врагам в начале хода.",
    Cost = 201,
    SellPrice = 101,
    Acquisition = "Магазин и Событие: Цветок госсипиума",
    Keywords = "кровотечение, bleed, оглушение, offenseLevelDown, ослабление атаки, хлопок",
    Sources = new List<Sources>
    {
        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.13 },
        new Sources { Location = "Событие: Цветок госсипиума", Type = "Event", DropRate = 0.08 }
    }
},
...
new EgoGift
{
    ...
    Tier = 2,
    Status = "Заряд",
    ImagePath = "Resources/Images/EGO/Tier2/Бейдж сотрудника.png",
    Effect = "При активации А-Рез. Гнева или при использовании Скилла, дающего или применяющего Счётчик charge, все союзники получат +3 к Счётчику charge в следущем Начале Хода. (Один раз за Ход)",
    Description = "Бейдж сотрудника, усиливающий генерацию заряда для всей команды при активации Гнева или использовании зарядных навыков.",
    Cost = 195,
    SellPrice = 98,
    Acquisition = "Магазин и Событие: Забытый сотрудник",
    Keywords = "заряд, charge, гнев, А-рез, усиление команды, бейдж",
    Sources = new List<Sources>
    {
        new Sources { Location = "Магазин", Type = "Shop", DropRate = 0.14 },
        new Sources { Location = "Событие: Забытый сотрудник", Type = "Event", DropRate = 0.07 }
    }
},
